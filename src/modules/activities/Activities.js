...
import { getActivity, deleteActivity } from "../../common/apis/activities";
...
const Activities = () => {
  ...
  const handleDelete = async () => {
    try {
      await deleteActivity(selectedRow.id);
      await refetch();
      setOpenDeleteModal(false);

      toast.success(`Successfully deleted The Activity ${selectedRow.name}`, {
        position: "top-right",
        autoClose: 1000,
